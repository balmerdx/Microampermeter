...
output/base/Core/Src/main.o: ./Core/Src/main.c
	@echo 'Building target: main.c'
	@$(CC) $(C_FLAGS) -o "$@" "$<"

output/base/Core/Src/stm32h7xx_hal_msp.o: ./Core/Src/stm32h7xx_hal_msp.c
	@echo 'Building target: stm32h7xx_hal_msp.c'
	@$(CC) $(C_FLAGS) -o "$@" "$<"

output/base/Core/Src/stm32h7xx_it.o: ./Core/Src/stm32h7xx_it.c
	@echo 'Building target: stm32h7xx_it.c'
	@$(CC) $(C_FLAGS) -o "$@" "$<"

output/base/Core/Src/system_stm32h7xx.o: ./Core/Src/system_stm32h7xx.c
...
output/base/Core/Src/hardware/m25p16.o: ./Core/Src/hardware/m25p16.c
	@echo 'Building target: m25p16.c'
	@$(CC) $(C_FLAGS) -o "$@" "$<"

output/base/Core/Src/hardware/qspi.o: ./Core/Src/hardware/qspi.c
	@echo 'Building target: qspi.c'
	@$(CC) $(C_FLAGS) -o "$@" "$<"
...
output/base/Core/Src/gui/scene_single.o: ./Core/Src/gui/scene_single.c
	@echo 'Building target: scene_single.c'
	@$(CC) $(C_FLAGS) -o "$@" "$<"
